 ...
 * MODIFY THAI SUPPORT BY 9DE@WX
 *MAIL : MSDOS43@WINDOWSLIVE.COM
 */
...
(function($){
	...
	$.addFlex = function(t,p){
		...
		p = $.extend({
			...
			minheight: 260, //min height of columns
			...
			changePage: function (ctype){ //change page
				...
				switch(ctype)
				{
					case 'first':
						...
						break;
					case 'prev':
						if (p.page>1) p.newp = p.page - 1;
						break;
					case 'next':
						if (p.page<p.pages) p.newp = p.page + 1;
						break;
					case 'last':
						p.newp = p.pages;
						break;
				...
				(
					function (){
						...
						.click(
							...
							{ 
								if($(this).find('input').attr('type')=='checkbox'){
									...
									$(this).parent().toggleClass('trSelected'); 
									...
									var code = $(this).parent().attr('id').split('row').join('');
									me.LoadEdit(code);
								}
							}
							)
						...
						if ($.browser.msie&&$.browser.version<7.0){
							...
							.hover(
								function () {
									$(this).parent().addClass('trOver');
								},
								function () {
									$(this).parent().removeClass('trOver');
								}
								)
						;
						}
		...
		if (p.usepager)
		{
			...
			$(g.bDiv).after(g.pDiv);
			var html = ' <div class="pGroup"> <div class="pFirst pButton"><span></span></div><div class="pPrev pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">Page <input type="text" size="3" value="1" style="text-align:center;" /> from <span> 1 </span></span></div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pNext pButton"><span></span></div><div class="pLast pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pReload pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pPageStat"></span></div>';
			...
			if (p.searchitems)
			{
				...
				$(g.sDiv).append("<div class='sDiv2'>Search : <select name='qtype'>"+sopt+"</select> <input type='text' size='30' name='q' class='qsbox' /> </div>");
				...
				$('#DeleteSelect',g.sDiv).click(function(){
					vl.DeleteSelect();
				});
				$(g.bDiv).after(g.sDiv);				
