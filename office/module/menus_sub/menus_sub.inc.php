...
function Add(){
  ...
  $menu = $obj->LoadOne('menus', array('code'=>$data['menu_code']));
  $permission=array(
    'name' => '',
    'menu_id' => $menu['id'].'-'.$data['id'],
    'pertype' => '',
    'user_create' => $user,
    'user_update' => $user,
    'date_create' => $datenow,
  ...
  $permission['name'] = 'แสดง'.$data['name'];
  $permission['pertype'] = 'VIEW';
  $obj->Add('permissions', $permission);

  $permission['name'] = 'เพิ่ม'.$data['name'];
  $permission['pertype'] = 'ADD';
  $obj->Add('permissions', $permission);

  $permission['name'] = 'แก้ไข'.$data['name'];
  $permission['pertype'] = 'EDIT';
  $obj->Add('permissions', $permission);

  $permission['name'] = 'ลบ'.$data['name'];
  $permission['pertype'] = 'DEL';
  $obj->Add('permissions', $permission);  
